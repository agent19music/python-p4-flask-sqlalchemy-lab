...
class Animal(db.Model):
    ...
    species = db.Column(db.String(170), nullable=False)
    enclosure_id = db.Column(db.ForeignKey('enclosures.id' ), nullable=False)
    zookeeper_id = db.Column(db.ForeignKey('zookeepers.id', ondelete='CASCADE'), nullable=False)